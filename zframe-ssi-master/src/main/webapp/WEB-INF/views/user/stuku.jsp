...
<link rel="stylesheet" type="text/css" href="style/xmdata.css"/>
<script type="text/javascript" src="js/function.js"></script>
<script type="text/javascript" src="js/xmdata.js"></script>
<!--[if IE 6]>
			...
			<div class="container">
				...
				<div class="nav-collapse">
					<ul class="nav" id="navID">
						...
						<li class="active"><a href="xmdata.html"><b>项目数据库</b></a></li>
   ...
   <div class="clearfix pt-3">
		  <div class="index-news-img spanm3 pull-left pt-5">
			<a href="javascript:;" title="标题标题标题" target="_blank" rel="bookmark">
             <img class="lazyloadimg" alt="标题标题标题标题标题标题" src="images/xmdata1.jpg"/></a>
		 </div>
