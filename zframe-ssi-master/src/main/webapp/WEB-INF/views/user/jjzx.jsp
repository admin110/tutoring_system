...
<link rel="stylesheet" type="text/css" href="${__static__}/user/style/list1.css"/>
<script type="text/javascript" src="${__static__}/user/js/function.js"></script>
<script type="text/javascript" src="${__static__}/user/js/list.js"></script>
<!--[if IE 6]>
...
<!--头部代码结束-->
	...
	<div class="row">
	   ...
	   <div class="clearfix">
				...
				<div class="pull-left classifyDIV pt-10 my1D6597">创新服务</div>
