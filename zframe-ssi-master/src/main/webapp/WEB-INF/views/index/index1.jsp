...
<head>
	...
	<link rel="stylesheet" href="${__static__}/admin/css/templatemo-style.css">
...
<body data-spy="scroll" data-target="#rock-navigation">
		...
		<div class="container">
			...
			<nav class="collapse navbar-collapse" id="rock-navigation">
				<ul class="nav navbar-nav navbar-right main-navigation text-uppercase">
					...
					<li><a href="regist" class="smoothScroll">注册</a></li>
					<li><a href="login" class="smoothScroll">登陆</a></li>
				</ul>	
			</nav>
	...
	<script src="${__static__}/admin/js/smoothscroll.js"></script>
	<script src="${__static__}/admin/js/jquery.nav.js"></script>
	<script src="${__static__}/admin/js/isotope.js"></script>
	<script src="${__static__}/admin/js/imagesloaded.min.js"></script>
